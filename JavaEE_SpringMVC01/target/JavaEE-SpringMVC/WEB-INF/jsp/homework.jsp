...
<div class="div1">
    ...
    <ul style="line-height: 40px">
        <li><a href="/JavaEE_SpringMVC01_war_exploded/list/addHomework">布置作业</a></li>
        <li><a href="/JavaEE_SpringMVC01_war_exploded/list/addStudent">添加学生</a></li>
        <li><a href="/JavaEE_SpringMVC01_war_exploded/list/homework">查看作业</a></li>
        <li><a href="/JavaEE_SpringMVC01_war_exploded/list/showstudenthomework">提交情况</a></li>
        <li><a href="/JavaEE_SpringMVC01_war_exploded/list/showstudent">查看学生</a></li>
...
<form id="sub" method="get" action="/JavaEE_SpringMVC01_war_exploded/list/submithomework">
